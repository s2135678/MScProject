...
# Dotplot
pdf("/Users/serachoi/Documents/Edinburgh/MScProject/Project/outs/es-derived/dotplot1.pdf", width = 12, height = 6)
dittoDotPlot(object = ec, 
...
ggplot(msig_C5_tidy_ec, aes(reorder(Description, NES), NES)) + geom_col(aes(fill=p.adjust< 0.2)) + theme_minimal() + coord_flip() + theme(axis.text = element_text(size = 14)) + scale_fill_manual(values = c(mycoloursP[4],mycoloursP[5])) 
dev.off()
```
