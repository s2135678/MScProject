...
dittoDotPlot(object = ec, 
  ...
  theme(axis.text = element_text(size=13), legend.text = element_text(size = 12), axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=0.4))
```
...
#Barplot
ggplot(msig_C5_result_es[1:10,], aes(reorder(Description, NES), NES)) + geom_col(aes(fill=p.adjust< 0.2)) + theme_minimal() + coord_flip() + theme(axis.text = element_text(size = 11))
```
...
#Barplot
ggplot(msig_H_tidy_ec, aes(reorder(Description, NES), NES)) + geom_col(aes(fill=p.adjust< 0.2)) + theme_minimal() + coord_flip() + theme(axis.title = element_text(size = 12))
```
...
#Barplot
pdf("/Users/serachoi/Documents/Edinburgh/MScProject/Project/outs/GO_ec.pdf")
ggplot(msig_C5_tidy_ec, aes(reorder(Description, NES), NES)) + geom_col(aes(fill=p.adjust< 0.2)) + theme_minimal() + coord_flip() + theme(axis.title = element_text(size = 12))
dev.off()
```
