...
VlnPlot(ec, features = "percent.ribo", group.by = "AgeGroup", pt.size = 0.01, cols = mycoloursP[1:20])
VlnPlot(ec, features = c("RPL37","RPS21"), group.by = "AgeGroup", assay="RNA")
...
all.markers <- rbind(old.markers_stringent[1:20,], all.markers_young)
all.markers$gene <- rownames(all.markers)
all.markers[order(all.markers$avg_log2FC, decreasing = TRUE),]
all.markers$log10_FDR <- -log10(all.markers$p_val_adj)

pdf("/Users/serachoi/Documents/Edinburgh/MScProject/Project/outs/Age_barplot_noRibo.pdf", width = 13, height = 5)
